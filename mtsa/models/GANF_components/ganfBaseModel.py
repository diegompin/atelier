...
from mtsa.models.interfaces.anomalyDetectionModel import AnomalyDetectionModel
from mtsa.models.interfaces.observer import Observer


class GANFBaseModel(nn.Module, AnomalyDetectionModel):
    def __init__(
        self,
        n_blocks=6,
        input_size=1,
    ...
    def set_adjacent_matrix(self, adj):
        self.adjacent_matrix = adj
        
    def getInitalAdj(self):
        return self.initialAdj
    ...
    def fit(
        ...
        self.initialAdj = self.adjacent_matrix.detach().clone()
                ...
                for epoch in tqdm(range(self.epochs), desc="epochs"):
                    ...
                    for dataloader in dataloaders:
                        for x in dataloader:
                            ...
                            foward_count += 1
                    #print(
                    #    "Epoch: {}, train -log_prob: {:.2f}, h: {}".format(
                    #        epoch, np.mean(loss_train), h.item()
                    #    )
                    #)
